...
do
    ...
    then
        ...
        release_title=$(curl -s --url "${api_url}/${previous_tag}" --header "Authorization: Bearer ${GH_TOKEN}" --header "X-GitHub-Api-Version: 2022-11-28" | jq -r '.name')
